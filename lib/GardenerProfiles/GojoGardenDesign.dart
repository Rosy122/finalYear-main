...
class GojoGardenDesign extends StatefulWidget {
  final String name;
  ...
  @override
  _GojoGardenDesignState createState() => _GojoGardenDesignState();
}

class _GojoGardenDesignState extends State<GojoGardenDesign> {
...
class GojoGardenDesignPage extends StatelessWidget {
  const GojoGardenDesignPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const GojoGardenDesign(
      name: 'Gojo Lama',
      experience: '12 years of experience in garden design services.',
      rating: 4.7,
      bio:
