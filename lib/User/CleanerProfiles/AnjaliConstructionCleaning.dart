...
class AnjaliConstructionCleaning extends StatefulWidget {
  final String name;
  ...
  @override
  _AnjaliConstructionCleaningState createState() =>
      _AnjaliConstructionCleaningState();
}

class _AnjaliConstructionCleaningState
    extends State<AnjaliConstructionCleaning> {
...
class MyHomePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AnjaliConstructionCleaning(
      name: 'Anjali Thapa',
      experience: '6 years of experience in post-construction cleaning.',
      rating: 4.9,
      bio:
