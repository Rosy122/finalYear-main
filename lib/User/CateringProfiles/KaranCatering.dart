...
class KaranVermaCateringService extends StatefulWidget {
  final String name;
  ...
  const KaranVermaCateringService({
    super.key,
    required this.name,
  ...
  @override
  _KaranVermaCateringServiceState createState() =>
      _KaranVermaCateringServiceState();
}

class _KaranVermaCateringServiceState extends State<KaranVermaCateringService> {
...
class KaranVermaCateringServicePage extends StatelessWidget {
  const KaranVermaCateringServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const KaranVermaCateringService(
      name: 'Karan Verma',
      experience: '12 years of experience in catering services.',
      rating: 4.7,
      bio:
      ...
      reviews: [
        ...
        },
        {
          ...
          'reviewText': 'Perfect for large events. Great food and service!',
        },
        {
