...
class RabinPlanting extends StatefulWidget {
  final String name;
  ...
  @override
  _RabinPlantingState createState() => _RabinPlantingState();
}

class _RabinPlantingState extends State<RabinPlanting> {
...
class RabinPlantingPage extends StatelessWidget {
  const RabinPlantingPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RabinPlanting(
      name: 'Rabin Shahi',
      experience: '8 years of experience in planting services.',
      rating: 4.8,
      bio:
