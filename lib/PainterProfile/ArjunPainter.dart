...
class ArjunPainter extends StatefulWidget {
  final String name;
  ...
  @override
  _ArjunPainterState createState() => _ArjunPainterState();
}

class _ArjunPainterState extends State<ArjunPainter> {
...
// RadhikaGardenDesignPage (Sample provider page)
class ArjunPainterPage extends StatelessWidget {
  const ArjunPainterPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const ArjunPainter(
      name: 'Arjun Pandey',
