...
class RohitWindowCleaning extends StatefulWidget {
  final String name;
  ...
  @override
  _RohitWindowCleaningState createState() => _RohitWindowCleaningState();
}

class _RohitWindowCleaningState extends State<RohitWindowCleaning> {
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const RohitWindowCleaning(
      ...
      providerId: 'your_provider_id_here', // Firestore document ID for likes
    );
  }
}
