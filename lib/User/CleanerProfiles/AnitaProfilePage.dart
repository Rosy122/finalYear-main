...
class AnitaProfilePage extends StatefulWidget {
  final String name;
  ...
  final String providerId; // Firestore document ID for Anita

  const AnitaProfilePage({
    super.key,
    required this.name,
  ...
  @override
  _AnitaProfilePageState createState() => _AnitaProfilePageState();
}

class _AnitaProfilePageState extends State<AnitaProfilePage> {
...
class AnitaProfilePageCaller extends StatelessWidget {
  const AnitaProfilePageCaller({super.key});

  @override
  Widget build(BuildContext context) {
    return AnitaProfilePage(
      name: 'Anita Thapa',
      ...
      reviews: [
        ...
        {
          'reviewerName': 'Rajeev',
          'reviewText': 'Anita did a great job, highly recommend her!',
        },
        {
          'reviewerName': 'Mina',
      ...
      providerId:
          'anita_thapa_document_id', // Use the actual Firestore document ID for Anita
    );
  }
}
