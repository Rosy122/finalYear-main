...
class RajeshConstructionCleaning extends StatefulWidget {
  final String name;
  ...
  @override
  _RajeshConstructionCleaningState createState() =>
      _RajeshConstructionCleaningState();
}

class _RajeshConstructionCleaningState
    extends State<RajeshConstructionCleaning> {
...
class MyHomePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const RajeshConstructionCleaning(
      name: 'Rajesh Sharma',
      experience: '7 years of experience in construction cleaning.',
      rating: 4.8,
      bio:
