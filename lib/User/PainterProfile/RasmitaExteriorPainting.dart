...
class RasmitaPainting extends StatefulWidget {
  final String name;
  ...
  @override
  _RasmitaPaintingState createState() => _RasmitaPaintingState();
}

class _RasmitaPaintingState extends State<RasmitaPainting> {
...
// RasmitaExteriorPaintingPage (Sample provider page)
class RasmitaExteriorPaintingPage extends StatelessWidget {
  const RasmitaExteriorPaintingPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RasmitaPainting(
      name: 'Rasmita Thapa',
      experience: '12 years of experience in exterior painting services.',
      rating: 4.8,
      bio:
