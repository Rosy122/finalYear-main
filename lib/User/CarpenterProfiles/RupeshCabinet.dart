...
class RupeshSharmaCabinetInstallationService extends StatefulWidget {
  final String name;
  ...
  @override
  _RupeshSharmaCabinetInstallationServiceState createState() =>
      _RupeshSharmaCabinetInstallationServiceState();
}

class _RupeshSharmaCabinetInstallationServiceState
    extends State<RupeshSharmaCabinetInstallationService> {
...
class RupeshSharmaCabinetInstallationServicePage extends StatelessWidget {
  const RupeshSharmaCabinetInstallationServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RupeshSharmaCabinetInstallationService(
      name: 'Rupesh Sharma',
      experience: '6 years of experience in cabinet installation services.',
      rating: 4.8,
      bio:
