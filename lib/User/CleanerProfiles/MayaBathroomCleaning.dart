...
class MayaBathroomCleaning extends StatefulWidget {
  final String name;
  ...
  @override
  _MayaBathroomCleaningState createState() => _MayaBathroomCleaningState();
}

class _MayaBathroomCleaningState extends State<MayaBathroomCleaning> {
...
class MyHomePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const MayaBathroomCleaning(
      name: 'Maya Thapa',
      experience: '5 years of experience in professional bathroom cleaning.',
      rating: 4.9,
      bio:
      ...
      reviews: [
        ...
        },
        {
          ...
          'reviewText': 'Professional and thorough service. Very satisfied!',
        },
        {
      ...
      imagePath:
          'assets/MayaBathroomCleaner.PNG', // Specify the path to the image asset
