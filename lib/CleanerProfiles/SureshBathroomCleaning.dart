...
class SureshBathroomCleaning extends StatefulWidget {
  final String name;
  ...
  @override
  _SureshBathroomCleaningState createState() => _SureshBathroomCleaningState();
}

class _SureshBathroomCleaningState extends State<SureshBathroomCleaning> {
