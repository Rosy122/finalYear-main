...
class SunitaJoshiProfile extends StatefulWidget {
  final String name;
  ...
  @override
  _SunitaJoshiProfileState createState() => _SunitaJoshiProfileState();
}

class _SunitaJoshiProfileState extends State<SunitaJoshiProfile> {
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const SunitaJoshiProfile(
      ...
      providerId: 'sunita_provider_id_here', // Firestore document ID here
    );
  }
}
