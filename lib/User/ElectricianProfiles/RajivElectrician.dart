...
class RajivElectrician extends StatefulWidget {
  final String name;
  ...
  @override
  _RajivElectricianState createState() => _RajivElectricianState();
}

class _RajivElectricianState extends State<RajivElectrician> {
...
class RajivElectricianPage extends StatelessWidget {
  const RajivElectricianPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RajivElectrician(
      name: 'Rajiv Kumar',
      experience: '10 years of experience in electrical services.',
      rating: 4.9,
      bio:
      ...
      providerId:
          'provider_id_here', // Specify the provider ID here for Firestore
    );
  }
}
