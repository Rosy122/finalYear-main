...
class SpecialOccasionMakeupPage extends StatelessWidget {
  const SpecialOccasionMakeupPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Special Occasion Makeup Service'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage(
                        'assets/Special.PNG'), // Add your special occasion makeup image path here
                    fit: BoxFit.cover,
                  ),
                ),
                height: 150,
              ...
              const Text(
                'Special occasion makeup service provides stunning looks for various events, including birthdays, anniversaries, and corporate functions.',
              ...
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Event-Ready Makeup',
                description: 'Perfect makeup for any special occasion.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Customized Looks',
                description: 'Makeup tailored to suit your event and outfit.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Hairstyling',
                description: 'Elegant and stylish hairstyles.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Accessory Assistance',
                description:
                    'Help with incorporating accessories into your look.',
              ),
              const SizedBox(height: 20),
              const Text(
                'Top Special Occasion Makeup Artists',
                style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                  color: Color.fromARGB(255, 122, 165, 160),
