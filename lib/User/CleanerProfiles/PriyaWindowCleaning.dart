...
class PriyaWindowCleaning extends StatefulWidget {
  final String name;
  ...
  final String providerId; // Firestore document ID for likes

  const PriyaWindowCleaning({
    super.key,
    required this.name,
  ...
  @override
  _PriyaWindowCleaningState createState() => _PriyaWindowCleaningState();
}

class _PriyaWindowCleaningState extends State<PriyaWindowCleaning> {
