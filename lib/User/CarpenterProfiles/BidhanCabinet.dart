...
class BidhanCabinetInstallationService extends StatefulWidget {
  final String name;
  ...
  @override
  _BidhanCabinetInstallationServiceState createState() =>
      _BidhanCabinetInstallationServiceState();
}

class _BidhanCabinetInstallationServiceState
    extends State<BidhanCabinetInstallationService> {
...
class BidhanCabinetInstallationServicePage extends StatelessWidget {
  const BidhanCabinetInstallationServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const BidhanCabinetInstallationService(
      name: 'Bidhan Shrestha',
      experience: '7 years of experience in cabinet installation services.',
      rating: 4.9,
      bio:
