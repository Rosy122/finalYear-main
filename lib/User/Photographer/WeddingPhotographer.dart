...
class WeddingPhotographyPage extends StatelessWidget {
  const WeddingPhotographyPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Wedding Photography'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage(
                        'assets/Wedding.PNG'), // Add your wedding photography image path here
                    fit: BoxFit.cover,
                  ),
                ),
                height: 150,
              ...
              const Text(
                'Wedding photography services capture every magical moment of your special day with precision and artistry.',
              ...
              const IncludedServiceTile(
                ...
                description: 'Beautiful pre-wedding moments captured in style.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Wedding Ceremony Coverage',
                description: 'Complete coverage of the wedding ceremony.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Candid Photography',
                description:
                    'Natural, candid moments captured during the event.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'High-Resolution Edited Photos',
