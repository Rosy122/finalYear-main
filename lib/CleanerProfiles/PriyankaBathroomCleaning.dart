...
class PriyankaBathroomCleaning extends StatefulWidget {
  final String name;
  ...
  const PriyankaBathroomCleaning({
    super.key,
    required this.name,
  ...
  @override
  _PriyankaBathroomCleaningState createState() =>
      _PriyankaBathroomCleaningState();
}

class _PriyankaBathroomCleaningState extends State<PriyankaBathroomCleaning> {
...
class MyHomePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const PriyankaBathroomCleaning(
      name: 'Priyanka Joshi',
      experience: '6 years of experience in professional bathroom cleaning.',
      rating: 4.8,
      bio:
      ...
      imagePath:
          'assets/PriyankaBathroomCleaner.PNG', // Specify the path to the image asset
