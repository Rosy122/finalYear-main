...
class PabitraLawnMowing extends StatefulWidget {
  final String name;
  ...
  @override
  _PabitraLawnMowingState createState() => _PabitraLawnMowingState();
}

class _PabitraLawnMowingState extends State<PabitraLawnMowing> {
...
class PabitraLawnMowingPage extends StatelessWidget {
  const PabitraLawnMowingPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const PabitraLawnMowing(
      name: 'Pabitra Lama',
      experience: '10 years of experience in lawn mowing services.',
      rating: 4.9,
      bio:
