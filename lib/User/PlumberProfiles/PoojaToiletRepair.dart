...
class PoojaToiletRepair extends StatefulWidget {
  final String name;
  ...
  @override
  _PoojaToiletRepairState createState() => _PoojaToiletRepairState();
}

class _PoojaToiletRepairState extends State<PoojaToiletRepair> {
...
class PoojaToiletRepairPage extends StatelessWidget {
  const PoojaToiletRepairPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const PoojaToiletRepair(
      name: 'Pooja Sharma',
      experience: '8 years of experience in toilet repair services.',
      rating: 4.7,
      bio:
