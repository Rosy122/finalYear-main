...
class SujanPainting extends StatefulWidget {
  final String name;
  ...
  @override
  _SujanPaintingState createState() => _SujanPaintingState();
}

class _SujanPaintingState extends State<SujanPainting> {
...
// SujanExteriorPaintingPage (Sample provider page)
class SujanExteriorPaintingPage extends StatelessWidget {
  const SujanExteriorPaintingPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const SujanPainting(
      name: 'Sujan Sharma',
      experience: '9 years of experience in exterior painting services.',
      rating: 4.7,
      bio:
