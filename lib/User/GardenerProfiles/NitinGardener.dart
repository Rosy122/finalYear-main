...
class NitinGardener extends StatefulWidget {
  final String name;
  ...
  @override
  _NitinGardenerState createState() => _NitinGardenerState();
}

class _NitinGardenerState extends State<NitinGardener> {
...
class NitinGardenerPage extends StatelessWidget {
  const NitinGardenerPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const NitinGardener(
      name: 'Nitin Yadav',
      experience: '6 years of experience in gardening services.',
      rating: 4.7,
      bio:
