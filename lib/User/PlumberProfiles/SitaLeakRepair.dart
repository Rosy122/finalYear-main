...
class SitaLeakRepairProfile extends StatefulWidget {
  final String name;
  ...
  @override
  _SitaLeakRepairProfileState createState() => _SitaLeakRepairProfileState();
}

class _SitaLeakRepairProfileState extends State<SitaLeakRepairProfile> {
...
class SitaLeakRepairPage extends StatelessWidget {
  const SitaLeakRepairPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const SitaLeakRepairProfile(
      name: 'Sita Sharma',
      experience: '7 years of experience in leak repair services.',
      rating: 4.8,
      bio:
