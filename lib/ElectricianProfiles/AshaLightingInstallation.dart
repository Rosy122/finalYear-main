...
class AshaLightingInstallation extends StatefulWidget {
  final String name;
  ...
  const AshaLightingInstallation({super.key,
    required this.name,
  ...
  @override
  _AshaLightingInstallationState createState() =>
      _AshaLightingInstallationState();
}

class _AshaLightingInstallationState extends State<AshaLightingInstallation> {
...
class AshaLightingInstallationPage extends StatelessWidget {
  const AshaLightingInstallationPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const AshaLightingInstallation(
      name: 'Asha Khadka',
      experience: '6 years of experience in lighting installation services.',
      rating: 4.8,
      bio:
