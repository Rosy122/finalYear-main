...
class RaviGardener extends StatefulWidget {
  final String name;
  ...
  @override
  _RaviGardenerState createState() => _RaviGardenerState();
}

class _RaviGardenerState extends State<RaviGardener> {
...
class RaviGardenerPage extends StatelessWidget {
  const RaviGardenerPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RaviGardener(
      name: 'Ravi Kumar',
      experience: '7 years of experience in gardening services.',
      rating: 4.8,
      bio:
