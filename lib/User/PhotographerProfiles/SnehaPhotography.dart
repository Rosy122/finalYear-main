...
class SnehaRaoPhotographyService extends StatefulWidget {
  final String name;
  ...
  @override
  _SnehaRaoPhotographyServiceState createState() =>
      _SnehaRaoPhotographyServiceState();
}

class _SnehaRaoPhotographyServiceState
    extends State<SnehaRaoPhotographyService> {
...
class SnehaRaoPhotographyServicePage extends StatelessWidget {
  const SnehaRaoPhotographyServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const SnehaRaoPhotographyService(
      name: 'Sneha Rao',
      experience: '7 years of experience in photography services.',
      rating: 4.8,
      bio:
