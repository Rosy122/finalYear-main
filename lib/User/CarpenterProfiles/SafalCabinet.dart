...
class SafalThapaCabinetInstallationService extends StatefulWidget {
  final String name;
  ...
  @override
  _SafalThapaCabinetInstallationServiceState createState() =>
      _SafalThapaCabinetInstallationServiceState();
}

class _SafalThapaCabinetInstallationServiceState
    extends State<SafalThapaCabinetInstallationService> {
...
class SafalThapaCabinetInstallationServicePage extends StatelessWidget {
  const SafalThapaCabinetInstallationServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const SafalThapaCabinetInstallationService(
      name: 'Safal Thapa',
      experience: '9 years of experience in cabinet installation services.',
      rating: 4.7,
      bio:
