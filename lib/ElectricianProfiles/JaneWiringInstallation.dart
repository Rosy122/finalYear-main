...
class JaneWiringInstallation extends StatefulWidget {
  final String name;
  ...
  @override
  _JaneWiringInstallationState createState() => _JaneWiringInstallationState();
}

class _JaneWiringInstallationState extends State<JaneWiringInstallation> {
...
class JaneWiringInstallationPage extends StatelessWidget {
  const JaneWiringInstallationPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const JaneWiringInstallation(
      name: 'Jane Shrestha',
      experience: '10 years of experience in wiring installation services.',
      rating: 4.8,
      bio:
