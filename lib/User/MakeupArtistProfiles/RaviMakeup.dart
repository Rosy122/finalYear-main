...
class RaviMehtaMakeupService extends StatefulWidget {
  final String name;
  ...
  @override
  _RaviMehtaMakeupServiceState createState() => _RaviMehtaMakeupServiceState();
}

class _RaviMehtaMakeupServiceState extends State<RaviMehtaMakeupService> {
...
class RaviMehtaMakeupServicePage extends StatelessWidget {
  const RaviMehtaMakeupServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RaviMehtaMakeupService(
      name: 'Ravi Mehta',
      experience: '5 years of experience in makeup artistry.',
      rating: 4.7,
      bio:
      ...
      reviews: [
        ...
        },
        {
          ...
          'reviewText': 'He’s amazing at what he does. Highly recommend!',
        },
        {
          'reviewerName': 'Priya Singh',
          'reviewText': 'His makeup skills are top-notch. Will hire again.',
        },
      ],
