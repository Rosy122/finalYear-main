...
class RameshDeepCleaner extends StatefulWidget {
  final String name;
  ...
  @override
  _RameshDeepCleanerState createState() => _RameshDeepCleanerState();
}

class _RameshDeepCleanerState extends State<RameshDeepCleaner> {
...
class MyHomePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const RameshDeepCleaner(
      name: 'Ramesh Sharma',
      experience: '5 years of experience in deep cleaning services.',
      rating: 4.8,
      bio:
      ...
      reviews: [
        ...
        },
        {
          ...
          'review': 'Very punctual and thorough. Highly recommended!'
        },
        {
      ...
      providerId: 'ramesh_provider_id_here', // Firestore document ID
    );
  }
}
