...
class KrishnaElectricalRepair extends StatefulWidget {
  final String name;
  ...
  @override
  _KrishnaElectricalRepairState createState() =>
      _KrishnaElectricalRepairState();
}

class _KrishnaElectricalRepairState extends State<KrishnaElectricalRepair> {
...
class KrishnaElectricalRepairPage extends StatelessWidget {
  const KrishnaElectricalRepairPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const KrishnaElectricalRepair(
      name: 'Krishna Sharma',
      experience: '7 years of experience in electrical repair services.',
      rating: 4.8,
      bio:
