...
class PartyMakeupPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Party Makeup Service'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage(
                        'assets/Party.PNG'), // Add your party makeup image path here
                    fit: BoxFit.cover,
                  ),
                ),
                height: 150,
              ...
              const Text(
                'Party makeup service offers glamorous looks for parties and events, tailored to your preferences and style.',
              ...
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Customized Party Makeup',
                description: 'Personalized makeup look to suit your event.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Hairstyling',
                description: 'Stylish and elegant hairstyles for any occasion.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Quick Touch-up',
                description: 'Assistance with touch-ups during the event.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Accessories Setup',
                description: 'Help with accessories to complete your look.',
              ),
              const SizedBox(height: 20),
              const Text(
                'Top Party Makeup Artists',
                style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                  color: Color.fromARGB(255, 122, 165, 160),
