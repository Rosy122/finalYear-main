...
class RadhikaGardenDesign extends StatefulWidget {
  final String name;
  ...
  @override
  _RadhikaGardenDesignState createState() => _RadhikaGardenDesignState();
}

class _RadhikaGardenDesignState extends State<RadhikaGardenDesign> {
...
class RadhikaGardenDesignPage extends StatelessWidget {
  const RadhikaGardenDesignPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RadhikaGardenDesign(
      name: 'Radhika Gurung',
      experience: '10 years of experience in garden design services.',
      rating: 4.9,
      bio:
