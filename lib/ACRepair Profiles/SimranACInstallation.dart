...
class SimranACInstallation extends StatefulWidget {
  final String name;
  ...
  @override
  _SimranACInstallationState createState() => _SimranACInstallationState();
}

class _SimranACInstallationState extends State<SimranACInstallation> {
...
class SimranACInstallationPage extends StatelessWidget {
  const SimranACInstallationPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const SimranACInstallation(
      name: 'Simran Sharma',
      experience: '7 years of experience in AC installation services.',
      rating: 4.8,
      bio:
