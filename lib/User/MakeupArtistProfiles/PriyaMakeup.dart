...
class PriyaSinghMakeupService extends StatefulWidget {
  final String name;
  ...
  @override
  _PriyaSinghMakeupServiceState createState() =>
      _PriyaSinghMakeupServiceState();
}

class _PriyaSinghMakeupServiceState extends State<PriyaSinghMakeupService> {
...
class PriyaSinghMakeupServicePage extends StatelessWidget {
  const PriyaSinghMakeupServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const PriyaSinghMakeupService(
      name: 'Priya Singh',
      experience: '8 years of experience in makeup artistry.',
      rating: 4.9,
      bio:
      ...
      reviews: [
        ...
        },
        {
          ...
          'reviewText': 'She did an amazing job for the party makeup.',
        },
        {
          'reviewerName': 'Sneha Rao',
          'reviewText': 'Her makeup skills are exceptional. Loved the outcome!',
        },
      ],
