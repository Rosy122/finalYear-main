...
class MeeraGardener extends StatefulWidget {
  final String name;
  ...
  @override
  _MeeraGardenerState createState() => _MeeraGardenerState();
}

class _MeeraGardenerState extends State<MeeraGardener> {
...
class MeeraGardenerPage extends StatelessWidget {
  const MeeraGardenerPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const MeeraGardener(
      name: 'Meera Dhakal',
      experience: '5 years of experience in gardening services.',
      rating: 4.6,
      bio:
