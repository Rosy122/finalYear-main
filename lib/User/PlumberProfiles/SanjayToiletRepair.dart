...
class SanjayToiletRepair extends StatefulWidget {
  final String name;
  ...
  @override
  _SanjayToiletRepairState createState() => _SanjayToiletRepairState();
}

class _SanjayToiletRepairState extends State<SanjayToiletRepair> {
...
class SanjayToiletRepairPage extends StatelessWidget {
  const SanjayToiletRepairPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const SanjayToiletRepair(
      name: 'Sanjay Karki',
      experience: '10 years of experience in toilet repair services.',
      rating: 4.8,
      bio:
