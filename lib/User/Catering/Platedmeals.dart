...
class PlatedMealsPage extends StatelessWidget {
  const PlatedMealsPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Plated Meals Service'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage('assets/Plated.PNG'),
                    fit: BoxFit.cover,
                  ),
                ),
                height: 150,
              ...
              const Text(
                'Plated meals service offers formal, individually plated meals for your special occasions, served with elegance and care.',
              ...
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Customized Menus',
                description: 'Personalized menu options for each course.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Elegant Presentation',
                description:
                    'Meals presented beautifully for formal occasions.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Trained Servers',
                description:
                    'Professional servers to ensure a smooth experience.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'High-Quality Ingredients',
                description: 'Meals prepared with premium, fresh ingredients.',
              ),
              const SizedBox(height: 20),
              const Text(
                'Top Caterers for Plated Meals',
                style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                  color: Color.fromARGB(255, 122, 165, 160),
