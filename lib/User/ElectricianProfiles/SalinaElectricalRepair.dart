...
class SalinaElectricalRepair extends StatefulWidget {
  ...
  @override
  _SalinaElectricalRepairState createState() => _SalinaElectricalRepairState();
}
...
class SalinaElectricalRepairPage extends StatelessWidget {
  const SalinaElectricalRepairPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const SalinaElectricalRepair(
      name: 'Salina Lama',
      experience: '12 years of experience in electrical repair services.',
      rating: 4.7,
      bio:
