...
class RajuProfilePage extends StatefulWidget {
  final String name;
  ...
  final String providerId; // Firestore document ID for the provider

  const RajuProfilePage({
    super.key,
    required this.name,
  ...
  @override
  _RajuProfilePageState createState() => _RajuProfilePageState();
}

class _RajuProfilePageState extends State<RajuProfilePage> {
...
class RajuProfilePageCaller extends StatelessWidget {
  const RajuProfilePageCaller({super.key});

  @override
  Widget build(BuildContext context) {
    return RajuProfilePage(
      name: 'Raju Shrestha',
      ...
      reviews: [
        ...
        {
          'reviewerName': 'Rajeev',
          'reviewText': 'Raju did a great job, highly recommend him!',
        },
        {
          'reviewerName': 'Mina',
      ...
      providerId:
          'raju_shrestha_document_id', // Use the actual Firestore document ID for Raju
    );
  }
}
