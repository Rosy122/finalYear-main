...
class SharmilaGardenDesign extends StatefulWidget {
  ...
  @override
  _SharmilaGardenDesignState createState() => _SharmilaGardenDesignState();
}
...
class SharmilaGardenDesignPage extends StatelessWidget {
  const SharmilaGardenDesignPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const SharmilaGardenDesign(
      name: 'Sharmila Kumar',
      experience: '7 years of experience in garden design services.',
      rating: 4.8,
      bio:
