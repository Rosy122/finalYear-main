...
class RamitaInteriorPainting extends StatefulWidget {
  final String name;
  ...
  @override
  _RamitaPaintingState createState() => _RamitaPaintingState();
}

class _RamitaPaintingState extends State<RamitaInteriorPainting> {
...
// RamitaInteriorPaintingPage (Sample provider page)
class RamitaInteriorPaintingPage extends StatelessWidget {
  const RamitaInteriorPaintingPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RamitaInteriorPainting(
      name: 'Ramita Thapa',
      experience: '8 years of experience in interior painting services.',
      rating: 4.8,
      bio:
