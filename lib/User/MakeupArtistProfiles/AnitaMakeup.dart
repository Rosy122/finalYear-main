...
class AnitaSharmaMakeupService extends StatefulWidget {
  final String name;
  ...
  const AnitaSharmaMakeupService({
    super.key,
    required this.name,
  ...
  @override
  _AnitaSharmaMakeupServiceState createState() =>
      _AnitaSharmaMakeupServiceState();
}

class _AnitaSharmaMakeupServiceState extends State<AnitaSharmaMakeupService> {
...
class AnitaSharmaMakeupServicePage extends StatelessWidget {
  const AnitaSharmaMakeupServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const AnitaSharmaMakeupService(
      name: 'Anita Sharma',
      experience: '6 years of experience in makeup artistry.',
      rating: 4.8,
      bio:
      ...
      reviews: [
        ...
        },
        {
          ...
          'reviewText': 'Loved her skills! Will definitely book her again.',
        },
      ],
