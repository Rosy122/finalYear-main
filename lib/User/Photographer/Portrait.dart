...
class PortraitPhotographyPage extends StatelessWidget {
  const PortraitPhotographyPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Portrait Photography'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage(
                        'assets/Potrait.PNG'), // Add your portrait photography image path here
                    fit: BoxFit.cover,
                  ),
                ),
                height: 150,
              ...
              const Text(
                'Portrait photography services offer professional portraits for individuals or groups, perfect for personal or professional use.',
              ...
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Individual Portraits',
                description: 'Professional portraits for personal use.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Group Portraits',
                description: 'Stylish portraits for families or friends.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Studio Photography',
                description:
                    'High-quality portraits taken in a studio setting.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
