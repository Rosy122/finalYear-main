...
class DeepakACRepair extends StatefulWidget {
  final String name;
  ...
  @override
  _DeepakACRepairState createState() => _DeepakACRepairState();
}

class _DeepakACRepairState extends State<DeepakACRepair> {
...
class DeepakACRepairPage extends StatelessWidget {
  const DeepakACRepairPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const DeepakACRepair(
      name: 'Deepak Sharma',
      experience: '10 years of experience in AC repair services.',
      rating: 4.9,
      bio:
