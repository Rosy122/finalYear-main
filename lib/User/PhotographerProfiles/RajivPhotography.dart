...
class RajivKumarPhotographyService extends StatefulWidget {
  final String name;
  ...
  @override
  _RajivKumarPhotographyServiceState createState() =>
      _RajivKumarPhotographyServiceState();
}

class _RajivKumarPhotographyServiceState
    extends State<RajivKumarPhotographyService> {
...
class RajivKumarPhotographyServicePage extends StatelessWidget {
  const RajivKumarPhotographyServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RajivKumarPhotographyService(
      name: 'Rajiv Kumar',
      experience: '6 years of experience in photography services.',
      rating: 4.7,
      bio:
      ...
      reviews: [
        {
          ...
          'reviewText': 'Rajiv’s photos were amazing. Definitely recommend!',
        },
        {
        ...
        {
          'reviewerName': 'Sneha Rao',
          'reviewText': 'Fantastic photographer! Made our event special.',
        },
      ],
