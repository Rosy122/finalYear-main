...
class SabiPlanting extends StatefulWidget {
  final String name;
  ...
  @override
  _SabiPlantingState createState() => _SabiPlantingState();
}

class _SabiPlantingState extends State<SabiPlanting> {
...
class SabiPlantingPage extends StatelessWidget {
  const SabiPlantingPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const SabiPlanting(
      name: 'Sabi Shah',
      experience: '10 years of experience in planting services.',
      rating: 4.9,
      bio:
