...
class HariLightingInstallation extends StatefulWidget {
  final String name;
  ...
  const HariLightingInstallation({
    super.key,
    required this.name,
  ...
  @override
  _HariLightingInstallationState createState() =>
      _HariLightingInstallationState();
}

class _HariLightingInstallationState extends State<HariLightingInstallation> {
...
class HariLightingInstallationPage extends StatelessWidget {
  const HariLightingInstallationPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const HariLightingInstallation(
      name: 'Hari Shrestha',
      experience: '8 years of experience in lighting installation services.',
      rating: 4.9,
      bio:
