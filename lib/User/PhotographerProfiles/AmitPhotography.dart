...
class AmitPatelPhotographyService extends StatefulWidget {
  final String name;
  ...
  @override
  _AmitPatelPhotographyServiceState createState() =>
      _AmitPatelPhotographyServiceState();
}

class _AmitPatelPhotographyServiceState
    extends State<AmitPatelPhotographyService> {
...
class AmitPatelPhotographyServicePage extends StatelessWidget {
  const AmitPatelPhotographyServicePage({super.key});

  @override
  Widget build(BuildContext context) {
    return const AmitPatelPhotographyService(
      name: 'Amit Patel',
      experience: '10 years of experience in photography services.',
      rating: 4.9,
      bio:
      ...
      reviews: [
        {
          ...
          'reviewText': 'Amit’s photography was amazing. Highly recommend!',
        },
        {
          'reviewerName': 'Rajiv Kumar',
          'reviewText': 'Great quality photos. Very professional!',
        },
        {
          'reviewerName': 'Amit Patel',
          'reviewText': 'Captured my wedding beautifully. Couldn’t be happier!',
        },
      ],
