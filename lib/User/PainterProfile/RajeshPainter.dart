...
class RajeshPainter extends StatefulWidget {
  final String name;
  ...
  @override
  _RajeshPainterState createState() => _RajeshPainterState();
}

class _RajeshPainterState extends State<RajeshPainter> {
...
// RajeshPainterPage (Sample provider page)
class RajeshPainterPage extends StatelessWidget {
  const RajeshPainterPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RajeshPainter(
      name: 'Rajesh Gurung',
      experience: '7 years of experience in painting services.',
      rating: 4.6,
      bio:
