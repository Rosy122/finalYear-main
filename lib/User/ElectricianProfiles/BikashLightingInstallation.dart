...
class BikashLightingInstallation extends StatefulWidget {
  ...
  @override
  _BikashLightingInstallationState createState() =>
      _BikashLightingInstallationState();
}

class _BikashLightingInstallationState
...
class BikashLightingInstallationPage extends StatelessWidget {
  const BikashLightingInstallationPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const BikashLightingInstallation(
      name: 'Bikash Lama',
      experience: '10 years of experience in lighting installation services.',
      rating: 4.7,
      bio:
