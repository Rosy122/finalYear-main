...
class TeaAndCoffeeServicePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tea and Coffee Service'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage(
                        'assets/Tea.PNG'), // Add your tea and coffee service image path here
                    fit: BoxFit.cover,
                  ),
                ),
                height: 150,
              ...
              const Text(
                'Tea and Coffee Service provides refreshing beverages for events, served with care and attention to detail.',
              ...
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Hot Tea & Coffee',
                description: 'Freshly brewed tea and coffee served hot.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Customizable Options',
                description: 'Choice of flavors and brewing styles.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Trained Baristas',
                description:
                    'Professional staff ensuring high-quality service.',
              ),
              const IncludedServiceTile(
                icon: Icons.check,
                service: 'Complementary Snacks',
